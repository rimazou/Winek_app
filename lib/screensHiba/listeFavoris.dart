...
String geohsh;
  ...
  {
          PlacesDetailsResponse place =await _places.getDetailsByPlaceId(this.placeid);
      ...
      print("is it what i want ? : ${placeDetail.name}”, “${placeDetail.formattedAddress}");
      return adr;
  }
   ...
   Future<String> convertLatLong() async{
        ...
        final addresses = await coord.Geocoder.google("AIzaSyBV4k4kXJRfG5RmCO3OF24EtzEzZcxaTrg",language:"fr")
