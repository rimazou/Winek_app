   ...
   LatLng latLng = new LatLng(geoFPointl.latitude, geoFPointl.longitude);
     ...
     String field = 'position';
      stream = geo.collection(collectionRef: collectionReference)
                                        .within(center:geoFPointl , radius: radius, field: field).listen(_updateMarkers);
 ...
 Completer<ImageInfo> completer = Completer();
  ...
  Future<void> _addMarker(double lat, double lng,String usrid) async {
     MarkerId id = MarkerId(usrid);
      ...
      icon: await getMarkerIcon("https://firebasestorage.googleapis.com/v0/b/winek-70176.appspot.com/o/photos%2FScreenshot_20200410-202649_Drive.jpg%7D?alt=media&token=422603f8-8f32-4292-9463-5af67345e1db",Size(200.0, 200.0)),
